...
public class presta {
    ...
    public void men() {
        ...
        System.out.println("men clothes size m");
        driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@id='framelive']")));
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(By.cssSelector("css=#category-3 > .dropdown-item")).click();
        driver.findElement(By.linkText("men")).click();
        driver.findElement(By.xpath("//ul[@id='facet_25076']/li/label/span/span")).click();
    }

    @Test
    public void menclothes() {
